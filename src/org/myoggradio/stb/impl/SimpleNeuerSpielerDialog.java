...
public class SimpleNeuerSpielerDialog extends JDialog implements NeuerSpielerDialog, ActionListener
{
	...
	public SimpleNeuerSpielerDialog()
	{
		setModal(true);
	...
	public void actionPerformed(ActionEvent ae) 
	{
		...
		if (source == butt1)
		{
			...
			int id = spielerManager.getMaxId(Parameter.spieler);
			spieler.setId(id + 1);
