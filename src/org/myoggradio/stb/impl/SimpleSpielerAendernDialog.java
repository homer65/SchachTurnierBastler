...
public class SimpleSpielerAendernDialog extends JDialog implements SpielerAendernDialog,ListSelectionListener
{
	private static final long serialVersionUID = 1L;
	private ArrayList<Spieler> spieler = null;
	private JPanel cpan = new JPanel();
	private JTable table = null;
	public SimpleSpielerAendernDialog()
	{
		setModal(true);
	}
	public void init()
	...
	public void valueChanged(ListSelectionEvent lse) 
	{
		...
		if (!isAdjusting)
		{
			...
			EinenSpielerAendernDialog esad = Factory.getEinenSpielerAendernDialog();
			esad.setSpieler(s);
			esad.anzeigen();
			dispose();
		}
