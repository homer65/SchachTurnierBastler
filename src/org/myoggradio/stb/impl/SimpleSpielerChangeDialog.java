...
public class SimpleSpielerChangeDialog extends JDialog implements SpielerChangeDialog,ListSelectionListener
{
	private static final long serialVersionUID = 1L;
	private ArrayList<Spieler> spieler = null;
	private JPanel cpan = new JPanel();
	private JTable table = null;
	public SimpleSpielerChangeDialog()
	{
		setModal(true);
	}
	public void init()
	...
	public void valueChanged(ListSelectionEvent lse) 
	{
		...
		if (!isAdjusting)
		{
			...
			EinenSpielerChangeDialog esad = Factory.getEinenSpielerChangeDialog();
			esad.setSpieler(s);
			esad.anzeigen();
			dispose();
		}
