...
public class SimpleJGJAuswertungsDialog extends JDialog implements JGJAuswertungsDialog, ListSelectionListener
{
	...
	{
		Protokol.write("SimpleJGJAuswertungsDialog:setRunde:Runde:" + n);
		this.rundeNummer = n;
